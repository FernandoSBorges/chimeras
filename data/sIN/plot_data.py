...
# Read data
#------------------------------------------------------------------------------
f = open(f'Pospischil2008_FS_sIN_data.json')
Pospischil2008_FS_sIN_data = json.load(f)

#------------------------------------------------------------------------------
# Set arrays
#------------------------------------------------------------------------------
amp = Pospischil2008_FS_sIN_data['simConfig']['IClamp0']['amp']
dur = Pospischil2008_FS_sIN_data['simConfig']['IClamp0']['dur']
start = Pospischil2008_FS_sIN_data['simConfig']['IClamp0']['start']
recordStep = Pospischil2008_FS_sIN_data['simConfig']['recordStep']

voltage = np.array(list(Pospischil2008_FS_sIN_data['simData']['V_soma'].values())[0])
time = np.array(Pospischil2008_FS_sIN_data['simData']['t'])
